...
const inputClassName =
  "rounded-[10px] border border-[#D5D2C4] bg-[#F8F6EF] px-4 py-3.5 text-[15px] text-[#2E332F] focus:border-[var(--nav-bg)] focus:outline-none";
...
export default function ContactForm() {
  ...
  if (state.success) {
    return (
      <div className="flex flex-col gap-2 rounded-2xl border border-[var(--nav-highlight)] bg-[#F3F1E9] p-7">
        <div
          className="text-xl"
