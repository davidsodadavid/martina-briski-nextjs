      ...
      <section className="flex flex-1 items-center px-6 py-8 md:px-10">
        <div className="mx-auto grid w-full max-w-[1267px] grid-cols-1 gap-5 sm:grid-cols-2">
          {TOOLS.map((tool, i) => (
            <div
              key={tool.href}
              className="group relative flex h-[190px] flex-col overflow-hidden border border-[var(--nav-overlay-text)]/25 bg-[var(--nav-bg)] transition-colors hover:border-[var(--nav-highlight)]"
            >
              <Link
                href={tool.href}
