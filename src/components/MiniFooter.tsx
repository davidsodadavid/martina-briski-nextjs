...
/** Just the bottom strip of SiteFooter (drifting wave line + social/lang
 * row + copyright/back-to-top) — for pages that don't need the full
 * programs/pages/practice footer. */
export default function MiniFooter({ backToTopLabel }: { backToTopLabel: string }) {
  return (
    <footer
      className="relative overflow-hidden px-6 pt-16 pb-8 text-[var(--nav-overlay-text)] md:px-10"
    ...
    >
      ...
      <div className="relative mx-auto flex w-full flex-wrap items-center justify-between gap-4 pb-2">
